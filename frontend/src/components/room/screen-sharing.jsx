...
function ParticipantVideoStrip({ participantVideos = [] }) {
    ...
    return (
        <div className="screen-share-strip">
            ...
            <div ref={stripRef} className="screen-share-strip-track">
        ...
        <div className={`screen-share-content ${cardVisible ? "is-visible" : ""}`}>
            <div className="screen-share">
                <div className="screen-share-media">
                    {isJoined && participantId && !overlayMounted ? (
                        <JitsiStage
                        ...
                        <div className="screen-share-empty">
                            Нет активной демонстрации экрана
                        </div>
                    ) : null}
                </div>
                ...
                <div className="screen-share-media">
                    {isJoined && participantId ? (
                        <JitsiStage
                            ...
                            mode="screen"
                            participantId={participantId}
                            className="screen-share-stage screen-share-stage--expanded"
                        />
                    ) : (
                        <div className="screen-share-empty">
                            Нет активной демонстрации экрана
